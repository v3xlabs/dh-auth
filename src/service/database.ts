 ...
 * @returns 
 */
export async function dataFetchUser(social_key: string, social_id: string, generator: () => PartialUser): Promise<User> {
    
    let social = await SocialID.find({where: {social_id: social_id, type: social_key}, relations: ["user"]});
